...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final _urlCtrl = TextEditingController(text: mainApplicationURL);
  ...
  void initState() {
    ...
    _urlCtrl.addListener(() {
      mainApplicationURL = _urlCtrl.text;
    });
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                flutterWebViewPlugin.launch(mainApplicationURL, hidden: true);
              },
              child: const Text('Open "hidden" Webview'),
            ),
            ElevatedButton(
              onPressed: () {
                flutterWebViewPlugin.launch(mainApplicationURL);
              },
